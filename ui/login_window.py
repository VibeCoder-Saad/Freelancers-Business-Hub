...
from PySide6.QtWidgets import (QDialog, QVBoxLayout, QHBoxLayout, QLabel, QLineEdit,
                               ...
                               QSizePolicy, QToolButton, QStyle, QRadioButton, QButtonGroup)
...
from ui.dialogs.privacy_dialog import PrivacyPolicyDialog
...
class LoginWindow(QDialog):
    ...
    def setup_register_ui(self):
        ...
        role_label = QLabel("I am a:"); role_label.setStyleSheet("color: #bac2de; font-weight: bold;")
        
        self.freelancer_radio = QRadioButton("Freelancer"); self.freelancer_radio.setChecked(True)
        self.freelancer_radio.setStyleSheet("color: #ffffff;")
        self.client_radio = QRadioButton("Client")
        self.client_radio.setStyleSheet("color: #ffffff;")
        
        self.role_group.addButton(self.freelancer_radio)
        self.role_group.addButton(self.client_radio)
        
        role_layout.addWidget(role_label)
        role_layout.addWidget(self.freelancer_radio)
        ...
        layout.addLayout(role_layout) # Added Role Layout
        layout.addStretch(1)
    ...
    def handle_login(self):
        ...
        if check_user(username, password):
            # Fetch role
            # Fetch role and ID
            from database.database_manager import get_user_role, get_user_id_by_username
    ...
    def handle_register(self):
        ...
        role = "Freelancer" if self.freelancer_radio.isChecked() else "Client"
        ...
        if create_user(username, password, role, consent_given):
